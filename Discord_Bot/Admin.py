...
class Admin(commands.Cog):
    ...
    async def kick_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            await ctx.send(f'{ctx.author.mention}, обязательно укажите пользователя, которого нужно удалить с сервера!')
    ...
    async def mute_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            await ctx.send(f'{ctx.author.mention}, обязательно укажите пользователя, которому нужно ограничить '
                           f'пользование чатом!')
    ...
    async def unmute_error(self, ctx, error):
        ...
        if isinstance(error, commands.MissingRequiredArgument):
            await ctx.send(f'{ctx.author.mention}, обязательно укажите пользователя, которому нужно снять ограничение '
                           f'на пользование чатом!')
